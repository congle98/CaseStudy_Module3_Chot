...
<nav class="navbar navbar-dark bg-dark fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand btn btn-outline-info" href="/Supervisor?action=home">Back to home</a>
    <a class="navbar-brand btn btn-outline-info" href="/Supervisor?action=classManager">Classroom Management</a>
